...
def des_cbc_encrypt_text(decrypt_text: str, key: str, iv="", method="base64", _pad='pkcs7') -> str:
    """
    DES加密
    ...
    :return: 加密后的数据
    """
    des_obj = DES.new(key.encode('utf-8'), DES.MODE_CBC, iv.encode('utf-8'))
...
def des_cbc_decrypt_text(encrypt_text: str, key: str, iv="", method="base64", _pad='pkcs7') -> str:
    """
    DES解密
...
print("加密", des_cbc_encrypt_text('123', '54cea83f', '35b90a2f', "base64"))
print("解密", des_cbc_decrypt_text('bp1abbNgh/o=', '54cea83f', '35b90a2f', "base64"))
print("\n加密", des_cbc_encrypt_text('12345', '54cea83f', '35b90a2f', "hex"))
print("解密", des_cbc_decrypt_text('1fb6f0d0d2a74500', '54cea83f', '35b90a2f', "hex"))
```
