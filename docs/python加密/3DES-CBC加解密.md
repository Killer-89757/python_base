...
def des3_cbc_encrypt_text(decrypt_text: str, key: str, iv="", method="base64", _pad='pkcs7') -> str:
    """
    DES3加密
    ...
    :return: 加密后的数据
    """
    des_obj = DES3.new(key.encode('utf-8'), DES3.MODE_CBC, iv.encode('utf-8'))
...
def des3_cbc_decrypt_text(encrypt_text: str, key: str, iv="", method="base64", _pad='pkcs7') -> str:
    """
    DES3解密
...
print("加密", des3_cbc_encrypt_text('123', "1234567890AB1234567890AB", '35b90a2f', "base64"))
print("解密", des3_cbc_decrypt_text('QEeZPqmGpBw=', '1234567890AB1234567890AB', '35b90a2f', "base64"))
print("\n加密", des3_cbc_encrypt_text('12345', "1234567890AB1234567890AB",  '35b90a2f', "hex"))
print("解密", des3_cbc_decrypt_text('da079d90ff673e36', "1234567890AB1234567890AB",  '35b90a2f', "hex"))
```
...
// CBC模式解密
console.log(decrypt_req("1234567890AB1234567890AB", "8c18266c4e8fa5de", 'fcD81O7KUlQqBM2U4k6WRMs74sw3NMHkOiY0bwxbsoTqhCi4nBxmuayhB4zfi0K5'));
```
